  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4 dark:text-black",
        caption: "flex justify-center pt-1 relative items-center",
        caption_label: "text-sm font-medium",
        nav: "space-x-1 flex items-center",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 dark:text-black"
        ),
        ...
        day_selected: "bg-primary text-primaryblue hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primaryblue-foreground",
