  ...
  return (
    <div className="relative ">
      ...
      <div 
        ...
        style={{ backgroundImage: `url(${bg})` }} // Chỉnh sửa đúng cách để sử dụng ảnh
      >
        <div className="absolute top-0 left-0 right-0 h-80 bg-black bg-opacity-70 flex items-center justify-center z-10">
          <div className="text-center">
            <h1 className="text-5xl font-semibold text-neutral-300">Chào mừng đến với trang của chúng tôi</h1>
            <p className="text-lg text-neutral-300 mt-2">Đặt vé xe khách online dễ dàng - Hành trình thuận tiện, giá cả hợp lý!</p>
            <p className="text-xs text-neutral-500 mt-2">By : Nguyen Thuan Hai - Le Tran Thu Lieu - Do Tien Khoa</p>
          </div>
        </div>
      </div>
